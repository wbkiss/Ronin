...
adimi_tool_admin_level_low   = 57 #Temp. Ban, Mute for all, Kick Players, GameId, AdminChat, Intern AdminChat, (modded) SetHP, Switch Teams, Force Balance, Freeze
adimi_tool_admin_level_mid   = 58 #Temp. Ban, Perm. Ban, Administration Panel, Mute for all, Kick Players, GameId, AdminChat, Intern AdminChat, Slay players, (modded) SetHP, Switch Teams, Force Balance
...
#the following is outdated... removed caused to performance issues
...
adimi_tool_custom_scene_begin = "scn_multi_scene_6_redux"
...
cmd_hack_options = 0
cmd_advanced_logging = num_hacks
cmd_player_join_message = num_hacks + 1
cmd_hack_consequence = num_hacks + 2
cmd_broadcast_hack_warnings = num_hacks + 3
cmd_broadcast_hack_consequences = num_hacks + 4
 
slot_troop_enable_anti_cheat = 1000
slot_troop_hack_percentage = 1001
slot_troop_item_attack_dir_caps = 1002
