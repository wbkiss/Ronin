...
[
    ...
    (str_store_string, s0, "@{s0} with UID {reg1} might be using unblockable attack hack"),
    (server_add_message_to_log, s0),

    (try_for_players, ":cur_player", 1),
        (this_or_next|player_is_admin, ":cur_player"),
		(this_or_next|player_slot_eq,":cur_player",adimi_tool_admin_level_low,1),
		(this_or_next|player_slot_eq,":cur_player",adimi_tool_admin_level_mid,1),
		(this_or_next|player_slot_eq,":cur_player",adimi_tool_admin_level_high,1),
