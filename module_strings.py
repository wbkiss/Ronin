...
#multiplayer scene names
  ...
  # CoMP maps
  ("multi_scene_abbey", "Abbey by MadocComadrin"),
  ("multi_scene_agrabah", "Agrabah"),
  ...
  ("multi_scene_goldrush", "Goldrush by Lord Rich"),
  ...
  ("multi_scene_open_plain", "Open Plains by KissMyAxe"),
  ("multi_scene_quagmire", "Quagmire by MadocComadrin"),
  ("multi_scene_rock_port", "Rock Port by Romans"),
  ("multi_scene_ruins_rebuilt", "Ruins Rebuilt by Erminas"),
  ("multi_scene_sally_out", "Sally Out"),
  ("multi_scene_sea_raiders_landing", "Sea Raiders Landing"),
  ("multi_scene_solace", "Solace by Romans"),
  ("multi_scene_stronghold", "Stronghold by Lord Rich"),
  ("multi_scene_swadian_town", "Swadian Town by MadocComadrin"),
  ("multi_scene_the_farm", "The Farm by Romans"),
  ("multi_scene_urabhaya", "Urabhaya by SotaMursu"),
  
  # OATS map pack
  ("multi_scene_hharkin", "Battle for Hharkin by Oats"),
  ("multi_scene_frosthaven", "Frosthaven by AZAN"),
  ("multi_scene_legacy_town", "Legacy Town by Zaffa"),
  ("multi_scene_naval_outpost", "Naval Outpost by Firunien"),
  ("multi_scene_steppe_village", "Steppe Village by Mitchell"),
  ("multi_scene_castellum", "Castellum by Mitchell"),
  ("multi_scene_river_village", "River Village by Reggae"),
